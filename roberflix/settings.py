"""
Django settings for roberflix project.
...
ALLOWED_HOSTS = ["projetoroberflix-production.up.railway.app", "localhost", "127.0.0.1"]
...
WSGI_APPLICATION = "roberflix.wsgi.application"
...
if DATABASE_URL:
    DATABASE = {
        'defaut': dj_database_url.config(default=DATABASE_URL,conn_max_age=600, conn_health_checks=True)
    }
